        ...
        for i in factors:
            ...
            try:
                if len(df_sub_outputs)>10 and len(df_sub_counts)>10:
                    ...
                    gsea_result, pvalues, cor_matrix = DE.run_drug_enrichment(df_drugs=df_sub_outputs, df_counts=w, drug_net=drug_net, shared_elements='broad_id', group='moa', min_elements=5, number_of_threads=-1, return_cormatrix=True)
